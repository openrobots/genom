...
\institute{\includegraphics[height=2cm]{openlaas}}
\date{October 2009}
...
\begin{itemize}
\item Openrobots tools installed in \verb|$prefix| (\texttt{/usr/local/openrobots}) 
%$
...
\frametitle{Edition of the module: emacs \texttt{genom} mode}
...
\begin{lstlisting}
(setq load-path 
  (cons "/usr/local/openrobots/genom/emacs"  load-path))
...
mkdir -p posix-build
/usr/local/openrobots/i386-linux/bin/mkdep -c"gcc" -oposix-build/dependencies -dposix-build 
-t.lo -DUNIX    -I. -I../.. -I../../server -I/usr/local/openrobots/i386-linux/include   
...
\begin{lstlisting}
blues% demoTest 1 
pocolibs execution environment version 2.5
Copyright (c) 1999-2008 CNRS-LAAS
...
\url{http://softs.laas.fr/openrobots/wiki/eltclsh}

\end{frame}
%----------------------------------------------------------------------
\begin{frame}
\frametitle{Module control with tclserv: use}
...
%----------------------------------------------------------------------
\begin{frame}
\frametitle{Module control with tclserv:  tk, \ldots}
...
\item 3D version: \url{http://softs.laas.fr/openrobots/wiki/gdhe}
\end{itemize}
...
%----------------------------------------------------------------------
\begin{frame}
\frametitle{Display with GDHE \ldots}

\url{http://softs.laas.fr/openrobots/wiki/gdhe}
...
\url{http://softs.laas.fr/openrobots/wiki/openprs}
...
\begin{itemize}
\item Official page:
\url{http://softs.laas.fr/openrobots/wiki/genom}

\item Robotpkg:
\url{http://www.laas.fr/~mallet/robotpkg}

\item Mailling-list: \url{openrobots@laas.fr}
